...
const variants = {
	...
	show_card: (props: StyleFunctionProps) => ({
		borderRadius: 'lg',
		bg: 'white',
		boxShadow: "md",
		color:'black',
	...
	product_card: (props: StyleFunctionProps) => ({
		borderRadius: 'lg',
		bg: 'white',
		boxShadow: "sm",
		color:'black',
	...
	dashed_container: (props: StyleFunctionProps) => ({
		border: '1px dashed',
		borderRadius: 'lg',
		paddingTop: '5',
		paddingBottom: '5',
	...
	dashed_container_menu_item: (props: StyleFunctionProps) => ({
		...props.theme.components.Container.variants.dashed_container(props),
		border:'1px solid',
		cursor: 'pointer',
		borderColor: mode('gray.200', 'whiteAlpha.400')(props),
		bg: 'bg-card',
	...
	dashed_container_menu_item_disabled: (props: StyleFunctionProps) => ({
		...props.theme.components.Container.variants.dashed_container_menu_item(props),
		cursor: 'not-allowed',
		border: '1px dashed',
		bg: 'bg-card',
		opacity: 0.4,
		//make it look like a disabled button with gray transparent background
